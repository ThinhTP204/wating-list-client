          ...
          {Array.from(groups.entries()).map(([position, rows], gi) => {
            ...
            return (
              <AnimatePresence key={position} initial={false}>
                {/* Group header row */}
                <TableRow className="bg-blue-50/50 dark:bg-blue-900/10 border-y border-neutral-100 dark:border-neutral-800/60 hover:bg-blue-50/70 dark:hover:bg-blue-900/20">
                  ...
                  rows.map((row, ri) => (
                    ...
                    >
                      ...
                      <TableCell className="px-4 py-3 pl-12">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-mono font-semibold bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300">
                          {row.code}
                        </span>
                      </TableCell>
