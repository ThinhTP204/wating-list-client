...
import ShiftHistoryPanel from "@/app/(admin)/admin/components/request/components/ShiftHistoryPanel";
...
export default function UserRequestPage() {
  ...
  return (
    <div className="flex-1 flex flex-row h-[calc(100vh-3.5rem)] overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/20 to-white dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
      {/* ── LEFT COLUMN: hero + marketplace ── */}
      <div className="flex-1 flex flex-col overflow-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        {/* ── Personal Hero ─────────────────────────────────────────────────── */}
        <motion.div
      ...
      <div className="w-80 shrink-0 hidden xl:flex flex-col border-l border-slate-200/80 dark:border-neutral-800 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm">
        <div className="p-4">
          <ShiftHistoryPanel />
        </div>
      </div>
