...
export const SHIFT_COLORS: Record<ShiftType, { bg: string; text: string; border: string; dot: string }> = {
  event: { bg: "bg-purple-50 dark:bg-purple-950/30", text: "text-purple-700 dark:text-purple-300", border: "border-purple-200 dark:border-purple-800", dot: "bg-purple-500" },
...
export const LABEL_META: Record<ShiftType, { name: string; color: string }> = {
  event: { name: "Sự kiện", color: "#8f58e4" },
