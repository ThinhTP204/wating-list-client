...
interface NavItemsProps {
  ...
  className?: string;
  onItemClick?: (
    item: { name: string; link: string; requireAuth?: boolean },
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl grid grid-cols-[auto_1fr_auto] items-center self-start rounded-full bg-transparent px-4 py-2 lg:grid dark:bg-transparent",
